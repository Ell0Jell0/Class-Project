...
export var wallSound = new soundFile("meowwall.mp3"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("meowpaddle.mp3");
soundArray.push(paddleSound);

export var scoreSound = new soundFile("meowscore.mp3");
